...
VL_INLINE_OPT void Vaxidemo___024root___ico_sequent__TOP__0(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___ico_sequent__TOP__0\n"); );
    // Init
...
void Vaxidemo___024root___eval_ico(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_ico\n"); );
    // Body
    if ((1ULL & vlSelf->__VicoTriggered.word(0U))) {
        Vaxidemo___024root___ico_sequent__TOP__0(vlSelf);
...
bool Vaxidemo___024root___eval_phase__ico(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_phase__ico\n"); );
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vaxidemo___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelf->__VicoTriggered.any();
    if (__VicoExecute) {
        Vaxidemo___024root___eval_ico(vlSelf);
    }
    return (__VicoExecute);
}

void Vaxidemo___024root___eval_act(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_act\n"); );
}

extern const VlUnpacked<IData/*25:0*/, 32> Vaxidemo__ConstPool__TABLE_hbec020df_0;

VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__0(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__0\n"); );
    // Init
    ...
    vlSelf->__Vdlyvset__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0 = 0U;
    ...
    if (((IData)(vlSelf->axidemo__DOT__video__DOT____Vcellinp__switch_clocks__i_wr) 
        ...
        vlSelf->__Vdlyvval__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0 
        ...
        vlSelf->__Vdlyvset__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0 = 1U;
        vlSelf->__Vdlyvdim0__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0 
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__2(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__2\n"); );
    // Init
    CData/*6:0*/ __Vtableidx3;
    __Vtableidx3 = 0;
    CData/*7:0*/ __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0;
    __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0;
    CData/*4:0*/ __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0;
    __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0;
    CData/*7:0*/ __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0;
    __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0;
    CData/*0:0*/ __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0;
    CData/*7:0*/ __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1;
    __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 0;
    CData/*4:0*/ __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1;
    __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 0;
    CData/*7:0*/ __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1;
    __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 0;
    CData/*0:0*/ __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 0;
    CData/*7:0*/ __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2;
    __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0;
    CData/*4:0*/ __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2;
    __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0;
    CData/*7:0*/ __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2;
    __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0;
    CData/*0:0*/ __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0;
    ...
    SData/*11:0*/ __Vdly__axidemo__DOT__video__DOT__genvga__DOT__hpos;
    __Vdly__axidemo__DOT__video__DOT__genvga__DOT__hpos = 0;
    SData/*11:0*/ __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos;
    __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos = 0;
    // Body
    ...
    __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos 
        = vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos;
    __Vdly__axidemo__DOT__video__DOT__genvga__DOT__hpos 
        = vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos;
    __Vdly__axidemo__DOT__video__DOT__s2pix__DOT__s_remaining 
        = vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__s_remaining;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0U;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 0U;
    __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0U;
    ...
    if (((IData)(vlSelf->axidemo__DOT__video__DOT____VdfgTmp_h023f5358__0) 
        ...
        if ((1U & (IData)(vlSelf->axidemo__DOT__video__DOT__dma_wstrb))) {
            __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 
                = (0xffU & vlSelf->axidemo__DOT__video__DOT__dma_wdata);
            __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 1U;
            __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 = 0U;
            __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0 
                = vlSelf->axidemo__DOT__video__DOT__cmap_waddr;
        }
        if ((2U & (IData)(vlSelf->axidemo__DOT__video__DOT__dma_wstrb))) {
            __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 
                = (0xffU & (vlSelf->axidemo__DOT__video__DOT__dma_wdata 
                            >> 8U));
            __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 1U;
            __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 = 8U;
            __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1 
                = vlSelf->axidemo__DOT__video__DOT__cmap_waddr;
        }
        if ((4U & (IData)(vlSelf->axidemo__DOT__video__DOT__dma_wstrb))) {
            __Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 
                = (0xffU & (vlSelf->axidemo__DOT__video__DOT__dma_wdata 
                            >> 0x10U));
            __Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 1U;
            __Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 = 0x10U;
            __Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2 
                = vlSelf->axidemo__DOT__video__DOT__cmap_waddr;
        }
    }
    ...
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vrd 
        = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos) 
            < (IData)(vlSelf->axidemo__DOT__video__DOT__vm_height)) 
           & (~ (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset)));
    if (vlSelf->axidemo__DOT__video__DOT__genvga__DOT__w_rd) {
        if (vlSelf->axidemo__DOT__video__DOT__genvga__DOT__lost_sync) {
            vlSelf->o_vga_blu = 0U;
            vlSelf->o_vga_grn = 0U;
            vlSelf->o_vga_red = 0U;
        } else {
            vlSelf->o_vga_blu = (0xffU & vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__pix_data);
            vlSelf->o_vga_grn = (0xffU & (vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__pix_data 
                                          >> 8U));
            vlSelf->o_vga_red = (0xffU & (vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__pix_data 
                                          >> 0x10U));
        }
    } else {
        vlSelf->o_vga_blu = 0U;
    ...
    __Vtableidx3 = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__r_newline) 
                                          ...
                                          (((IData)(vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__pix_hlast) 
                                           ...
                                           | (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__r_newframe) 
                                              ...
                                              | (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__w_rd) 
                                                  << 1U) 
                                                 | (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset)))))));
    if (vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset) {
        __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos = 0U;
        vlSelf->o_vga_vsync = 1U;
        vlSelf->axidemo__DOT__video__DOT__genvga__DOT__first_frame = 1U;
        __Vdly__axidemo__DOT__video__DOT__genvga__DOT__hpos = 0U;
        ...
        if (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
            ...
            __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos 
                = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos) 
                    < (0xfffU & ((IData)(vlSelf->axidemo__DOT__video__DOT__vm_raw) 
                                 - (IData)(1U)))) ? 
                   (0xfffU & ((IData)(1U) + (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos)))
                    : 0U);
            vlSelf->o_vga_vsync = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos) 
        ...
        if (vlSelf->axidemo__DOT__video__DOT__genvga__DOT__r_newframe) {
            vlSelf->axidemo__DOT__video__DOT__genvga__DOT__first_frame = 0U;
        }
        vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hrd 
            = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
                < ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_width) 
                   - (IData)(2U))) | ((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
                                      >= ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_raw) 
                                          - (IData)(2U))));
        __Vdly__axidemo__DOT__video__DOT__genvga__DOT__hpos 
            = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
                < (0xfffU & ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_raw) 
                             - (IData)(1U)))) ? (0xfffU 
                                                 & ((IData)(1U) 
                                                    + (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos)))
                : 0U);
        vlSelf->axidemo__DOT__video__DOT__genvga__DOT__r_newline 
            = ((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
               == ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_width) 
                   - (IData)(3U)));
        vlSelf->o_vga_hsync = (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
                                < (0xfffU & ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_porch) 
                                             - (IData)(1U)))) 
                               | ((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
                                  >= (0xfffU & ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_synch) 
                                                - (IData)(1U)))));
    }
    if (Vaxidemo__ConstPool__TABLE_hf62722bc_0[__Vtableidx3]) {
        vlSelf->axidemo__DOT__video__DOT__genvga__DOT__lost_sync 
            = Vaxidemo__ConstPool__TABLE_ha396ef74_0
            [__Vtableidx3];
    }
    ...
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__r_newframe 
        = ((~ (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset)) 
           & (((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos) 
               == ((IData)(vlSelf->axidemo__DOT__video__DOT__hm_width) 
                   - (IData)(3U))) & ((IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos) 
                                      == ((IData)(vlSelf->axidemo__DOT__video__DOT__vm_height) 
                                          - (IData)(1U)))));
    if (__Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0) {
        vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap[__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0))) 
                & vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap
                [__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0]) 
               | (0xffffffU & ((IData)(__Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0) 
                               << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v0))));
    }
    if (__Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1) {
        vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap[__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1))) 
                & vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap
                [__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1]) 
               | (0xffffffU & ((IData)(__Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1) 
                               << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v1))));
    }
    if (__Vdlyvset__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2) {
        vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap[__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2))) 
                & vlSelf->axidemo__DOT__video__DOT__s2pix__DOT__cmap
                [__Vdlyvdim0__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2]) 
               | (0xffffffU & ((IData)(__Vdlyvval__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2) 
                               << (IData)(__Vdlyvlsb__axidemo__DOT__video__DOT__s2pix__DOT__cmap__v2))));
    }
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__vpos 
        = __Vdly__axidemo__DOT__video__DOT__genvga__DOT__vpos;
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__hpos 
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__3(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__3\n"); );
    // Body
    if (vlSelf->axidemo__DOT____Vcellinp__memcontrol__S_AXI_ARESETN) {
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__4(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__4\n"); );
    // Body
    if (vlSelf->axidemo__DOT__video__DOT__pix_reset_n) {
    ...
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset 
        = ((1U & (~ (IData)(vlSelf->axidemo__DOT__video__DOT__pix_reset_n))) 
           || (IData)(vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset_pipe));
    vlSelf->axidemo__DOT__video__DOT__genvga__DOT__pix_reset_pipe 
        = (1U & (~ (IData)(vlSelf->axidemo__DOT__video__DOT__pix_reset_n)));
    vlSelf->axidemo__DOT__video__DOT__switch_clocks__DOT__lcl_rd_empty 
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__5(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__5\n"); );
    // Init
    IData/*31:0*/ __Vfunc_axidemo__DOT__video__DOT__apply_wstrb__0__prior_data;
    __Vfunc_axidemo__DOT__video__DOT__apply_wstrb__0__prior_data = 0;
    IData/*31:0*/ __Vfunc_axidemo__DOT__video__DOT__apply_wstrb__0__new_data;
    ...
    vlSelf->axidemo__DOT__video__DOT____VdfgTmp_h023f5358__0 
        = ((IData)(vlSelf->axidemo__DOT__video__DOT__awskd_valid) 
           & (IData)(vlSelf->axidemo__DOT__video__DOT__wskd_valid));
    if (vlSelf->__Vdlyvset__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0) {
        vlSelf->axidemo__DOT__video__DOT__switch_clocks__DOT__mem[vlSelf->__Vdlyvdim0__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0] 
            = vlSelf->__Vdlyvval__axidemo__DOT__video__DOT__switch_clocks__DOT__mem__v0;
    }
    vlSelf->axidemo__DOT__video__DOT__axil_read_ready 
        = ((IData)(vlSelf->axidemo__DOT__video__DOT__arskd_valid) 
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__6(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__6\n"); );
    // Body
    if (vlSelf->axidemo__DOT____Vcellinp__memcontrol__S_AXI_ARESETN) {
        if (((IData)(vlSelf->axidemo__DOT__video__DOT____Vcellinp__switch_clocks__i_wr) 
             & (~ (IData)(vlSelf->axidemo__DOT__video__DOT__afifo_full)))) {
...
VL_INLINE_OPT void Vaxidemo___024root___nba_comb__TOP__0(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_comb__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__7(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__7\n"); );
    // Body
    if (vlSelf->axidemo__DOT____Vcellinp__memcontrol__S_AXI_ARESETN) {
...
VL_INLINE_OPT void Vaxidemo___024root___nba_comb__TOP__1(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_comb__TOP__1\n"); );
    // Body
...
VL_INLINE_OPT void Vaxidemo___024root___nba_sequent__TOP__8(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___nba_sequent__TOP__8\n"); );
    // Body
...
void Vaxidemo___024root___eval_nba(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_nba\n"); );
    // Body
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
    }
    if ((0x10ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__2(vlSelf);
        vlSelf->__Vm_traceActivity[3U] = 1U;
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__3(vlSelf);
    }
    if ((8ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__4(vlSelf);
        vlSelf->__Vm_traceActivity[4U] = 1U;
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__5(vlSelf);
        vlSelf->__Vm_traceActivity[5U] = 1U;
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__6(vlSelf);
        vlSelf->__Vm_traceActivity[6U] = 1U;
    }
    if ((0x18ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_comb__TOP__0(vlSelf);
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__7(vlSelf);
        vlSelf->__Vm_traceActivity[7U] = 1U;
    }
    if ((5ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_comb__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[8U] = 1U;
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vaxidemo___024root___nba_sequent__TOP__8(vlSelf);
    }
}

void Vaxidemo___024root___eval_triggers__act(Vaxidemo___024root* vlSelf);

bool Vaxidemo___024root___eval_phase__act(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_phase__act\n"); );
    // Init
    VlTriggerVec<5> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    Vaxidemo___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        Vaxidemo___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool Vaxidemo___024root___eval_phase__nba(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_phase__nba\n"); );
    // Init
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = vlSelf->__VnbaTriggered.any();
    if (__VnbaExecute) {
        Vaxidemo___024root___eval_nba(vlSelf);
...
void Vaxidemo___024root___eval(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval\n"); );
    // Init
    ...
    while (__VicoContinue) {
        ...
        __VicoContinue = 0U;
        if (Vaxidemo___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
    ...
    while (__VnbaContinue) {
...
#ifdef VL_DEBUG
            Vaxidemo___024root___dump_triggers__nba(vlSelf);
#endif
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (Vaxidemo___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vaxidemo___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void Vaxidemo___024root___eval_debug_assertions(Vaxidemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxidemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaxidemo___024root___eval_debug_assertions\n"); );
    // Body
