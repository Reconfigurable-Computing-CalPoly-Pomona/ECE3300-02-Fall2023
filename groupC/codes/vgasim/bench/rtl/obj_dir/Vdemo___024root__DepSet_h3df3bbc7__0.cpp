...
void Vdemo___024root___eval_triggers__ico(Vdemo___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdemo___024root___eval_triggers__ico\n"); );
    // Body
...
void Vdemo___024root___eval_triggers__act(Vdemo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdemo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdemo___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->i_clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_clk__0))));
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->i_pixclk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_pixclk__0))));
    vlSelf->__VactTriggered.set(2U, ((((IData)(vlSelf->demo__DOT__vgai__DOT____Vcellinp__VIDEO_MEM__DOT__readmem____pinNumber3) 
                                       & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__demo__DOT__vgai__DOT____Vcellinp__VIDEO_MEM__DOT__readmem____pinNumber3__0))) 
                                      | ((IData)(vlSelf->demo__DOT__vgai__DOT__vga_newframe) 
                                         & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__demo__DOT__vgai__DOT__vga_newframe__0)))) 
                                     | ((IData)(vlSelf->i_clk) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_clk__0)))));
    vlSelf->__VactTriggered.set(3U, (((IData)(vlSelf->demo__DOT__vgai__DOT____Vcellinp__VIDEO_MEM__DOT__readmem____pinNumber3) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__demo__DOT__vgai__DOT____Vcellinp__VIDEO_MEM__DOT__readmem____pinNumber3__0))) 
                                     | ((IData)(vlSelf->i_pixclk) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_pixclk__0)))));
    vlSelf->__VactTriggered.set(4U, (((~ (IData)(vlSelf->demo__DOT__vgai__DOT__VIDEO_MEM__DOT__readmem__DOT__wb_reset_n)) 
                                      & (IData)(vlSelf->__Vtrigprevexpr___TOP__demo__DOT__vgai__DOT__VIDEO_MEM__DOT__readmem__DOT__wb_reset_n__0)) 
                                     | ((IData)(vlSelf->i_clk) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_clk__0)))));
    vlSelf->__VactTriggered.set(5U, (((~ (IData)(vlSelf->demo__DOT__vgai__DOT__VIDEO_MEM__DOT__readmem__DOT__pix_reset_n)) 
                                      & (IData)(vlSelf->__Vtrigprevexpr___TOP__demo__DOT__vgai__DOT__VIDEO_MEM__DOT__readmem__DOT__pix_reset_n__0)) 
                                     | ((IData)(vlSelf->i_pixclk) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i_pixclk__0)))));
