...
#ifndef VERILATED_VAXIDEMO_H_
#define VERILATED_VAXIDEMO_H_  // guard

#include "verilated.h"

class Vaxidemo__Syms;
class Vaxidemo___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vaxidemo VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vaxidemo__Syms* const vlSymsp;
  ...
  public:
    ...
    Vaxidemo___024root* const rootp;
    ...
    explicit Vaxidemo(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxidemo(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxidemo();
  private:
    VL_UNCOPYABLE(Vaxidemo);  ///< Copying not allowed
