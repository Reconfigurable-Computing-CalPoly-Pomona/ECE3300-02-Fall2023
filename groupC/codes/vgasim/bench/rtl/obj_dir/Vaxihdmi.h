...
#ifndef VERILATED_VAXIHDMI_H_
#define VERILATED_VAXIHDMI_H_  // guard

#include "verilated.h"

class Vaxihdmi__Syms;
class Vaxihdmi___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vaxihdmi VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vaxihdmi___024root* const rootp;
    ...
    explicit Vaxihdmi(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxihdmi(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxihdmi();
  private:
    VL_UNCOPYABLE(Vaxihdmi);  ///< Copying not allowed
