...
#ifndef VERILATED_VDEMO_H_
#define VERILATED_VDEMO_H_  // guard

#include "verilated.h"

class Vdemo__Syms;
class Vdemo___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vdemo VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    explicit Vdemo(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vdemo(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vdemo();
  private:
    VL_UNCOPYABLE(Vdemo);  ///< Copying not allowed
