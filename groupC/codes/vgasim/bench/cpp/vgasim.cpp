...
void	VGAWIN::init(void) {
	...
	this->signal_key_press_event().connect(sigc::mem_fun(*this, &VGAWIN::onKeyPress), false);
	this->signal_key_release_event().connect(sigc::mem_fun(*this, &VGAWIN::onKeyRelease), false);
